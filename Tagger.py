...
async def start(event):
  await event.reply("**🌀ErrorTaggerBot**\n ile Grubunuzdakı Nerdeyse Tüm Üyelere Etiket Ata bilirim \nKomutlar için =======> /help yazın**",
		      ...
		      [Button.url('Beni Gruba Ekle ➕', 'https://t.me/lucitaggerbot?startgroup=a')],
                      [Button.url('Support🛠', 'https://t.me/supppeerrt')],
...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Beni Gruba Ekle➕', 'https://t.me/ErrorTagger_bot?startgroup=a')],
                      [Button.url('Support👨‍💻', 'https://t.me/suppeerrt')],
                      [Button.url('Resmi Kanal🔖', 'https://t.me/taggersup')],
		      [Button.url('Developer🧑‍🔧', 'https://t.me/ozuduqaqaw')],
                    ),
                    link_preview=False
