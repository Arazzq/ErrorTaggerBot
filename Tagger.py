...
#  güzel isimler...!!! 
cumle = ['Üzümlü kekim ✨', 'Nar çiçəyi ✨', 'Papatya 🌼', 'Karanfil ✨', 'Gül 🌹', 'Ayıcık 🐻', 'Mutlu pandam 🐼', 'Ay parem ✨', 'Ballı lokmam ✨', 'Bebişim 🥰', 'Lale 🌷', 'Zambak ⚜', 'Nergis ✨', 'Sümbül ☘️', 'Nilüfer ☘️', 'Menekşe ⚜️', 'Lavanta ✨', 'Gül pare ✨', 'Reyhan 🌷', 'Kaktüs ⚜️', 'Böğürtlen ☘️', 'Orkide ☘️', 'Manolya ✨', 'Ayçiçeği ✨', 'Tweety ⚜️', 'Star ✨', 'Yonca 🍀', 'Ateş böceği ✨',]
#  güzel isimler...!!!
...
async def start(event):
  await event.reply("**ᴇʀʀᴏʀ ᴛᴀɢɢᴇʀ**, Grup və ya kanaldaki  bütün üzvləri çağıra bilərəm ★\nDaha çox məlumat üçün **/help**'i yazın.",
                    buttons=(
                      [
                         Button.url('➕ Məni  Grupa Sal ➕ ', 'http://t.me/ErrorTagger_Bot?startgroup=a')
                      ],
                      [
